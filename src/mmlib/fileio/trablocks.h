...
namespace IO 
{
	...
	/// \brief  Allows lines to be drawn in a BristolTrajectoryFormat file
	/// \details Allows lines to be drawn in a BristolTrajectoryFormat file. Used by OutTra_BTF. 
	/// \author Jon Rea 
	...
	public:
		...
		size_t getTraCapactity() const; ///< The underlying StringBuilder can be any size, but how much can we write to the BristolTrajectoryFormat file?
